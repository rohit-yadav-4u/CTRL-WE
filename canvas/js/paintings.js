            ...
            },
            {
              ...
              value: function destroy() {
                ...
                Object.keys(this.listeners).forEach(function (event) {
                  _this5.el.removeEventListener(
                    _this5.namespace + event,
                    _this5.checkEvent,
                    false
                  );
                });
        ...
        var _default$1 = /*#__PURE__*/ (function (_Core) {
          ...
          function _default() {
            ...
            _this = _possibleConstructorReturn(
              this,
              _getPrototypeOf(_default).call(this, options)
            );
            ...
            },
            {
              ...
              value: function addElements() {
                ...
                els.forEach(function (el, id) {
                  ...
                  var top =
                    el.getBoundingClientRect().top + _this3.instance.scroll.y;
...
*/
            ...
            },
            {
              ...
              value: function moveScrollBar(e) {
                ...
                if (!this.isTicking && this.isDraggingScrollbar) {
                  requestAnimationFrame(function () {
                    var y =
                      (((e.clientY * 100) / _this5.scrollbarHeight) *
                        _this5.instance.limit) /
                      100;
            ...
            },
            {
              ...
              value: function addElements() {
                ...
                this.sections.forEach(function (section, y) {
                  var els = _this6.sections[y].el.querySelectorAll(
                    "[data-".concat(_this6.name, "]")
                  );

                  els.forEach(function (el, id) {
                    var cl =
                      el.dataset[_this6.name + "Class"] || _this6["class"];
                    var top;
                    ...
                    if (!_this6.sections[y].inView) {
                      top =
                        ...
                        getTranslate(_this6.sections[y].el).y -
                ...
                this.parallaxElements.forEach(function (current, i) {
                  ...
                  if (current.inView || setAllElements) {
                    switch (current.position) {
                      case "top":
                        transformDistance =
                          _this8.instance.scroll.y * -current.speed;
                        break;
                      ...
                      default:
                        transformDistance =
                          (scrollMiddle - current.middle) * -current.speed;
                        break;
                    }
                  }
            ...
            },
            {
              ...
              value: function scrollTo(targetOption, offsetOption) {
                ...
                var scrollTarget = Math.max(
                  0,
                  Math.min(offset, this.instance.limit)
    ...
    tusV: [
      function (require, module, exports) {
        ...
        var images = Object.entries(require("../../img/demo5/*.jpg")); // track the mouse position
          ...
          _createClass(MenuItem, [
            {
              ...
              value: function layout() {
                ...
                this.DOM.reveal.style.perspective = "1000px"; // the next two elements could actually be only one, the image element
                ...
                this.DOM.revealImage.style.backgroundImage =
                  "url(" + this.DOM.el.getAttribute("data-img") + ")";
                ...
                this.tl = _gsap.gsap
                  .timeline({
                    onStart: function onStart() {
                      ...
                      _this2.DOM.reveal.style.opacity =
                        _this2.DOM.revealInner.style.opacity = 1; // set a high z-index value so image appears on top of other elements
            ...
            },
            {
              ...
              value: function render() {
                ...
                this.animatableProperties.ty.current =
                  ...
                  this.bounds.reveal.height / 2; // new rotation value

                this.animatableProperties.rotation.current = (0, _utils.map)(
                  Math.abs(mousepos.x - this.bounds.el.left),
                  0,
                  this.bounds.el.left + this.bounds.el.width,
                  -20,
                  20
      ...
      { gsap: "TpQl", "../utils": "MgTz", "../../img/demo5/*.jpg": "QmC7" },
    ],
    cS6P: [
      function (require, module, exports) {
        "use strict";
          ...
          function Menu(el) {
            ...
            _toConsumableArray(this.DOM.menuItems).forEach(function (
              ...
              return _this.menuItems.push(
                new _menuItem.default(item, pos, _this.animatableProperties)
              );
    ...
    u20R: [
      function (require, module, exports) {
        ...
        var _locomotiveScroll = _interopRequireDefault(
