!(function () {
  ...
  var r,
    ...
    vt = function (t) {
      ...
      for (r = t.length; r--; )
        (t[r] && (t[r]._gsap || (t[r]._gsap = new Ue(t[r], e)))) ||
          t.splice(r, 1);
      return t;
    },
    yt = function (t) {
    ...
    Vt = function (t, e) {
      ...
      if (
        ((e._time || (e._initted && !e._dur)) &&
          ((r = Ut(t.rawTime(), e)),
          (!e._dur || re(0, e.totalDuration(), r) - e._tTime > z) &&
            e.render(r, !0)),
    ...
    jt = function (t, e, r, n) {
      return (
        e.parent && Rt(e),
        (e._start = wt(
          (X(r) ? r : r || t !== i ? Kt(t, r, e) : t._time) + e._delay
        )),
        (e._end = wt(
    ...
    Wt = function (t, e) {
      return (
        (it.ScrollTrigger || at("scrollTrigger", e)) &&
    ...
    we = function (t, e, r) {
      var i,
        ...
        f,
        c,
        p = t ? (X(t) ? [t >> 16, (t >> 8) & ye, t & ye] : 0) : Te.black;
      if (!p) {
    ...
    Xe = (function () {
      ...
      return (
        ...
        (e.time = function (t, e) {
          return arguments.length
            ? this.totalTime(
                Math.min(this.totalDuration(), t + qt(this)) % this._dur ||
                  (t ? this._dur : 0),
                e
              )
            : this._time;
        ...
        (e.endTime = function (t) {
          return (
            this._start +
            (j(t) ? this.totalDuration() : this.duration()) / Math.abs(this._ts)
          );
        }),
  ...
  var Ne = (function (r) {
    ...
    return (
      ...
      (s.render = function (t, e, r) {
        ...
        if (y !== this._tTime || r || T) {
          ...
          if (n >= m && t >= 0)
            for (s = this._first; s; ) {
              if (
                ((a = s._next), (s._act || n >= s._start) && s._ts && l !== s)
              ) {
            ...
            for (var b = t < 0 ? t : n; s; ) {
              if (
                ((a = s._prev), (s._act || b <= s._end) && s._ts && l !== s)
              ) {
                if (s.parent !== this) return this.render(t, e, r);
                if (
                  (s.render(
      ...
      (s.addPause = function (t, e, r) {
        ...
        return (
          (i.data = "isPause"), (this._hasPause = 1), jt(this, i, Kt(this, t))
        );
      }),
  ...
  var Ve,
    ...
    We = function (t, e, r, i, n, s, a, o, u) {
      ...
      if (
        ...
        return isNaN(f * i) || "" === i
          ? (!l && !(e in t) && at(e, i),
            je.call(this, t, e, f, i, c, o || S.stringFilter, u))
          : ((h = new cr(
              this._pt,
              t,
              e,
    ...
    Ge = function (t, e, r, i, n, s) {
      ...
      if (
        ...
        for (u = r._ptLookup[r._targets.indexOf(n)], l = a._props.length; l--; )
          u[a._props[l]] = o;
      return a;
    },
    Qe = function t(e, n) {
        ...
        for (
          ...
          if (
            ...
            c &&
              ...
              ((e._pt = u =
                new cr(e._pt, h, p.name, 0, 1, p.render, p, 0, p.priority)),
            ...
            for (o in s)
              pt[o] && (p = Ge(o, s, e, d, h, I))
                ? p.priority && (l = 1)
                : (_[o] = u =
                    We.call(e, h, o, "get", s[o], d, I, 0, v.stringFilter));
    ...
    Je = (function (n) {
      function s(e, s, a, o) {
        ...
        var h,
          ...
          d,
          m,
          g = (u = n.call(this, o ? s : zt(s)) || this).vars,
          v = g.duration,
          y = g.delay,
          T = g.immediateRender,
          x = g.stagger,
        ...
        if (
          ...
          if (
            ((s = u.vars),
            (h = u.timeline =
              new Ne({ data: "nested", defaults: M || {} })).kill(),
            (h.parent = h._dp = t(u)),
            (h._start = 0),
            b)
          )
  ...
  var pr = {
    ...
    registerEffect: function (t) {
      ...
      (i || "").split(",").forEach(function (t) {
        return (
          t && !pt[t] && !it[t] && ot(e + " effect requires " + t + " plugin.")
        );
      }),
        (_t[e] = function (t, e, i) {
          ...
          function (e) {
            ...
            return ae(
              ...
              r.querySelectorAll
                ? r
                : r === t
                ? ot("Invalid scope") || a.createElement("div")
                : t
            );
          }
        );
  ...
  var gr,
    ...
    ai = function (t, e, r, i) {
      ...
      var a,
        ...
        m,
        g,
        v = new cr(this._pt, t.style, e, 0, 1, ar),
        y = 0,
        T = 0;
      if (
        ((v.b = r),
        ...
        (r += ""),
        "auto" === (i += "") &&
          ((t.style[e] = i), (i = Gr(t, e) || i), (t.style[e] = r)),
        ke((a = [r, i])),
        (i = a[1]),
        (u = (r = a[0]).match(J) || []),
        (i.match(J) || []).length)
      ...
      if (e.tween && e.tween._time === e.tween._dur) {
        ...
        if ("all" === o || !0 === o) (a.cssText = ""), (i = 1);
          ...
          for (n = (o = o.split(",")).length; --n > -1; )
            (r = o[n]),
              Mr[r] && ((i = 1), (r = "transformOrigin" === r ? jr : Vr)),
              ei(s, r);
        i &&
          (ei(s, Vr),
          u &&
          ...
          if (
            ...
            if (
              ...
              if (
                (D && f in D
                  ? ((s =
                      "function" == typeof D[f] ? D[f].call(r, i, t, n) : D[f]),
              ...
              if (
                d ||
                ((o || 0 === o) && (u || 0 === u) && !Sr.test(a) && f in O)
              )
                o || (o = 0),
                  (c = (s + "").substr((u + "").length)) !==
                    (p = ie(a) || (f in S.units ? S.units[f] : c)) &&
                    (u = ni(t, f, s, p)),
                  (this._pt = new cr(
                    this._pt,
                    d ? g : O,
  ...
  class Fi {
    ...
    mouseEnter(t) {
      ...
      Ei.timeline({ defaults: this.animationDefaults })
        .set(this.DOM.marquee, { y: "top" === e ? "-101%" : "101%" }, 0)
        .set(this.DOM.marqueeInner, { y: "top" === e ? "101%" : "-101%" }, 0)
        .to([this.DOM.marquee, this.DOM.marqueeInner], { y: "0%" }, 0);
    }
    mouseLeave(t) {
      const e = this.findClosestEdge(t);
      Ei.timeline({ defaults: this.animationDefaults })
        .to(this.DOM.marquee, { y: "top" === e ? "-101%" : "101%" }, 0)
        .to(this.DOM.marqueeInner, { y: "top" === e ? "101%" : "-101%" }, 0);
    }
    findClosestEdge(t) {
      return ((t, e, r, i) => {
